...
def build_skill_invocation_message(
    ...
    if loaded:
        ...
        scanned_dir = Path(str(skill_info.get("skill_dir") or ""))
        ...
        if scanned_dir.exists():
            for _subdir in ("references", "templates", "scripts", "assets"):
                _subdir_path = scanned_dir / _subdir
        ...
        if (
            ...
            or (has_scanned_supporting and loaded_dir_path != scanned_dir)
        ):
    ...
    scanned_supporting_dir = Path(str(skill_info.get("skill_dir") or ""))
    if scanned_supporting_dir.exists():
        for _subdir in ("references", "templates", "scripts", "assets"):
