...
object HermesLauncherShortcutBridge {
    const val ACTION_RUN_AUTOMATION_SHORTCUT = "com.nousresearch.hermesagent.RUN_AUTOMATION_SHORTCUT"
    const val EXTRA_AUTOMATION_ID = "com.nousresearch.hermesagent.extra.AUTOMATION_ID"
