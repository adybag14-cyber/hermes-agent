        ...
        return JSONObject()
            ...
            .put(
                ...
                "You are Hermes running inside the native Android app. " +
                    ...
                    "When the user asks to create a recurring phone automation, reusable Android task, Tasker-like variable, time/day trigger, phone-state trigger, app-foreground trigger, notification trigger, calendar event trigger, location trigger, sensor trigger, logcat entry trigger, Shizuku availability trigger, sunrise/sunset calculation, saved notification action, saved variable set/clear action, saved file action, safe saved Android settings action, saved visible-UI action, saved Android intent, broadcast, URI, activity launch, saved app-launch action, Quick Settings tile automation, home-screen widget automation, or backup/restore Hermes automations, call android_automation_tool. It can save shell, file-write, file-delete, variable set/clear, safe Android system-action, accessibility UI-action, app-launch, Android intent, Shizuku package-permission, offline sunrise/sunset, and notification post/cancel tasks, configure a user-added Hermes Quick Settings tile or home-screen widget to run a saved automation, calculate sun times directly, export/import Hermes automation bundles, run tasks manually, enable/disable/delete them, schedule interval and time-of-day tasks with Android alarms, run boot/power/battery/time/app-foreground/notification-posted/calendar-event/location/sensor/logcat-entry/Shizuku-state triggers, and expand saved variables in commands, file content, UI selectors, intent fields, package names, trigger packages, Shizuku state fields, sunrise/sunset location/date/timezone fields, notification action fields, variable action fields, and notification, calendar, location, sensor, logcat, or time event fields. " +
                                    ...
                                    .put(
                                        ...
                                        JSONObject()
                                            ...
                                            .put(
                                                ...
                                                JSONObject()
                                                    .put("type", "string")
                                                    .put("description", "Raw exported Tasker XML for import_tasker_xml. Imports only a safe subset: Run Shell, Write File, Delete File, Launch App, Browse URL, Notify, Variable Set, Variable Clear, Go Home, Back Button, Show Recents, Quick Settings, and safe settings-panel actions."),
                                            )
                                            .put(
                                                "tasker_data_uri",
                                                JSONObject()
