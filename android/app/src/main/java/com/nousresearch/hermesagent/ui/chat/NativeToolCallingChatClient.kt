                                    ...
                                    .put(
                                        ...
                                        JSONObject()
                                            ...
                                            .put(
                                                ...
                                                JSONObject()
                                                    .put("type", "integer")
                                                    .put("description", "Minimum debounce interval for start_sensor_watcher sensor events. Clamped between 250 and 60000 milliseconds."),
                                            )
                                            .put(
                                                "max_lines",
                                                JSONObject()
