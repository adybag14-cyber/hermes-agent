...
object AuthCatalog {
    val options = listOf(
        ...
        AuthOption(
            id = "chatgpt",
            label = "ChatGPT",
            description = "Open ChatGPT in the in-app browser, then paste a ChatGPT Web access token into Hermes Android.",
            scope = AuthScope.RuntimeProvider,
        ...
        AuthOption(
            id = "xai",
            label = "xAI / Grok",
            description = "Use an xAI Grok API key (or open console in the in-app browser) for Hermes Android remote model calls.",
            scope = AuthScope.RuntimeProvider,
            runtimeProvider = "xai",
