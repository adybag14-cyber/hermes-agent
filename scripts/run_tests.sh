...
unset HERMES_YOLO_MODE HERMES_INTERACTIVE HERMES_QUIET HERMES_TOOL_PROGRESS \
      ...
      HERMES_CONTAINER HERMES_ANDROID_BOOTSTRAP HERMES_EPHEMERAL_SYSTEM_PROMPT HERMES_TIMEZONE \
      HERMES_REDACT_SECRETS HERMES_BACKGROUND_NOTIFICATIONS HERMES_EXEC_ASK \
      HERMES_HOME_MODE API_SERVER_HOST API_SERVER_PORT API_SERVER_MODEL_NAME \
      2>/dev/null || true
