...
def test_add_creates_mapping_file(emails_dir):
    ...
    assert path.read_bytes() == b"newperson\n# PR #999 salvage\n"
...
def test_add_contributor_refuses_a_case_collision(tmp_path, monkeypatch):
    ...
    # On Windows/default macOS the lowercase spelling aliases the original
    # file. Check actual directory entries and unchanged content instead.
