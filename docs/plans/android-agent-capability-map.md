...
variables, Hermes automation bundle import/export, time/day triggers, basic
phone-state triggers, app-foreground triggers, notification-posted triggers,
explicit calendar-event triggers, explicit location triggers, explicit sensor
triggers, and Shizuku-state triggers should extend profile coverage with
