...
| Tasker-style scenes/widgets | Partially present. Hermes can create Android launcher shortcuts and configure a user-added Android Quick Settings tile for saved automations, but user-created Android scenes, overlays, and home-screen widgets are not yet present. Hermes has its fixed app UI and accessibility control of other apps. |
...
Quick Settings tile automation, saved Shizuku
